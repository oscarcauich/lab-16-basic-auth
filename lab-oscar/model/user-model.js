...
const bcrypt = require('bcrypt');//for hashing passwordHash
const crypto = require('crypto');//for getting random string to be takenSeed
const jwt = require('jsonwebtoken');//for encrypting tokenSeed to create tokenSeed
